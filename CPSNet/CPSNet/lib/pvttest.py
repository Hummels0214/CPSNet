...
class CFM(nn.Module):
    ...
    def forward(self, x1, x2, x3):
        ...
        x2_1 = torch.cat((x2_1, self.conv_upsample4(self.upsample(x1_0))), dim=1)  # 64,22,22
        x3_1 = self.conv_upsample1(self.upsample(x2_0)) * x3_0  # 32,44,44
        x3_1 = torch.cat((x3_1, self.conv_upsample4(self.upsample(x2))), dim=1)  # 64,44,44
...
class PolypPVT(nn.Module):
    ...
    def forward(self, x):
        ...
        cfm_feature1, cfm_feature2 = self.CFM(x4_t, x3_t, x2_t)
